    ...
    <a href="{base}/" class="brand">
      <span class="brand-mark" aria-hidden="true">
        <svg viewBox="0 0 32 32" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.4">
          <rect x="4.5" y="3.5" width="23" height="25" rx="1.5" />
          <path d="M9 9h14M9 13h14M9 17h10M9 21h14M9 25h8" stroke-linecap="round" />
        </svg>
      </span>
      <span class="brand-name">word-kit</span>
      <span class="brand-tag">ms</span>
    </a>
    <nav>
