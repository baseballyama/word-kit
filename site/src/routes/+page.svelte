  ...
  const features: Array<{ num: string; title: string; body: string }> = [
    {
      ...
      body: 'Every XML element word-kit does not yet model is preserved as a pass-through node in its original position. Opening and re-saving an unmodified template leaves Word\'s "needs repair" prompt out of the picture.',
    },
    {
      num: '02',
      title: 'PowerPoint-style templates',
      body: 'Open a hand-designed .docx, merge its styles into your authoring graph with mergeStylesFromTemplate, then keep appending. No {{placeholder}} dance required for the layout itself.',
    },
    {
      num: '03',
    ...
    {
      num: '04',
      title: 'Tree-shakeable function API',
      body: 'Every operation is a standalone export. A minimal createDocx + appendParagraph + toUint8Array slice bundles to ~42 KB minified; the full surface is ~131 KB. CI enforces both.',
    },
  ];
...
<svelte:head>
  <title>word-kit — Read, edit, and write Word .docx in Node and the browser</title>
</svelte:head>
...
<section class="hero">
  ...
  <div class="hero-inner">
    ...
    <p class="lede">
      WordprocessingML — paragraphs, runs, tables, styles, numbering, headers / footers, sections,
      images, comments, fields, tracked changes — modeled, edited, and serialized.
      <strong>Lossless round-trip</strong> for every part the library does not yet structure, so
...
<section class="examples">
  <div class="examples-inner">
    ...
    <p class="more">
      ...
      <a href="{base}/docs/recipes">Recipes</a>, and the
      <a href="{base}/playground">browser preview playground</a>.
    </p>
  </div>
</section>
